...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/test_bezier
  OBJDIR = obj/debug/test_bezier
  DEFINES += -DDEBUG
...
ifeq ($(config),release)
  ...
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/test_bezier
  OBJDIR = obj/release/test_bezier
  DEFINES +=
  INCLUDES += -I. -I../src -Isrc
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/test_bezier.o: projets/test_bezier.cpp
	@echo $(notdir $<)
