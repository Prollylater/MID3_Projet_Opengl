...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/test_ffd
  OBJDIR = obj/debug/test_ffd
  DEFINES += -DDEBUG
...
$(OBJDIR)/test_ffd.o: projets/test_ffd.cpp
	@echo $(notdir $<)
