...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/cubeworld
  OBJDIR = obj/debug/cubeworld
  DEFINES += -DDEBUG
...
$(OBJDIR)/cubeworld.o: projets/cubeworld.cpp
	@echo $(notdir $<)
