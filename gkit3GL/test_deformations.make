...
ifeq ($(config),debug)
  RESCOMP = windres
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/test_deformations
  OBJDIR = obj/debug/test_deformations
  DEFINES += -DDEBUG
...
ifeq ($(config),release)
  ...
  TARGETDIR = bin
  TARGET = $(TARGETDIR)/test_deformations
  OBJDIR = obj/release/test_deformations
  DEFINES +=
  INCLUDES += -I. -I../src -Isrc
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) ${CUSTOMFILES} $(OBJECTS) $(LDDEPS) $(RESOURCES) | $(TARGETDIR)
	@echo Linking test_deformations
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning test_deformations
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/test_deformations.o: projets/test_deformations.cpp
	@echo $(notdir $<)
